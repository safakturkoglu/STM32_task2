...
int main(void)
{
   ...
   while (1)
  {
    ...
    /* USER CODE END WHILE */
		...
		temp = adc_buffer[0] /8.215;
		sprintf((char *) usart_temp, "Temperature: %d  C \r\n", (int)temp);
		HAL_UART_Transmit(&huart1, (uint8_t *)usart_temp, 30,500);
		HAL_Delay(100);
		
		sprintf((char *) usart_temp, "Humidity: %d RH \r\n", (int)RH);
		HAL_UART_Transmit(&huart1, (uint8_t *)usart_temp, 30,500);
		HAL_Delay(100);
